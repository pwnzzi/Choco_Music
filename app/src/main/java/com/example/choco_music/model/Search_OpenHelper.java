...
public class Search_OpenHelper extends SQLiteOpenHelper {

    public static final String TABLE_NAME = "search";
    private static final String DATABASE= "search.db";
    private static final int DATABASE_VERSION = 2;
    private String sql;
    private Context context;

    public Search_OpenHelper(@Nullable Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sql = "CREATE TABLE IF NOT EXISTS search ( _id INTEGER PRIMARY KEY AUTOINCREMENT,"+
    ...
    public void insertData(String title, String vocal, String music_url, String album_url, String type){
        ...
        db.execSQL("INSERT INTO search VALUES(null,'"+title+"','"+vocal+"','"+music_url+"','"+album_url+"', '"+type+"')");
        db.close();
    }
    ...
    public ArrayList<ChartData> get_Music_saerch(){

        ArrayList<ChartData> music_playist_search = new ArrayList<>();
        ...
        while(cursor.moveToNext()){
            ...
            music_playist_search.add(music_playlist_data);

        }
        cursor.close();
        return music_playist_search;
    }
